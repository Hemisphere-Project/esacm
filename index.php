...
<div id="popup_overlay">
    ...
    $color=types_render_field( "text-popup-color", array( ) );
		...
		if($post_type=='image_popup'){?> <div class="popup image_popup"><?php echo $picture; ?> </div> <?php }
 		elseif($post_type=='text_popup'){?> <div class="popup text_popup typo_beta" style="color:<?php echo $color;?>; border-color:<?php echo $color;?>; box-shadow:0 0 8px 0 <?php echo $color;?>;" > <?php echo $text;?> </div> <?php } ?>

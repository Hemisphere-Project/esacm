			...
			<nav id="site-navigation" class="main-navigation">
				...
				<div id="esacm_logo_wrapper_mobile" class="only_mobile">
					<a href="<?php echo site_url(); ?>">
						...
						<?php if( is_home()||(in_array("parent-diplomes", $classes))||(in_array("single-actu", $classes))||(in_array("single-diplome", $classes))||(in_array("single-diplome-expo", $classes))||(in_array("parent-actus", $classes)) ){?>

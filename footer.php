...
?>
	...
	<footer id="colophon" class="site-footer">
		...
		<?php if( is_home() ){?>
		<div class="site-info">
			<div class="site-info-colonne-logo">
			...
			<div class="site-info-colonne-logo">
				<a target="_blank" href="https://fondation.michelin.com/">
					<img alt="Logo ESACM" src="<?php echo get_stylesheet_directory_uri();?>/img/logo_michelin_blanc.svg">
				</a>
			</div>
		</div>
		<?php } ?>
